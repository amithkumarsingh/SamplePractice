...
public class ImageSelectActivity extends HelperActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConstantsCustomGallery.limitCount = intent.getIntExtra(ConstantsCustomGallery.EXTRA_LIMIT_COUNT, 0);
     ...
     *
     * @param position
     * For image selection/un-selection.
     */
    private void toggleSelection(int position) {
        Log.i("ImageSelectActivity","selected count - "+countSelected);
        if ((!images.get(position).isSelected && countSelected >= ConstantsCustomGallery.limit) || (countSelected+1>ConstantsCustomGallery.limit-ConstantsCustomGallery.limitCount && !images.get(position).isSelected)) {
            Toast.makeText(
