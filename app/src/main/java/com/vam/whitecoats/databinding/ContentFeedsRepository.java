...
public class ContentFeedsRepository {
    ...
    public ContentFeedsRepository(){
        mutableLiveData = new SingleLiveEvent<>();
    }


    public ContentFeedsRepository(int doc_id, int category_id, int _pageNum) {
        this.user_id=doc_id;
    ...
    private String prepareGetCategoryListRequest() {
        ...
        try {
            ...
            reqObj.put("tag_id", TabsTagId.PROFESSIONAL_FEEDS.geTagId());
