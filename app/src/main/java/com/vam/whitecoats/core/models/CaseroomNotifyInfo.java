...
/**
 * Created by swathim on 21-09-2015.
 */
public class CaseroomNotifyInfo implements Serializable {

    private String caseroom_notify_id;
    ...
    public String getCaseroom_notify_id() {
        return caseroom_notify_id;
    }

    public void setCaseroom_notify_id(String caseroom_notify_id) {
        this.caseroom_notify_id = caseroom_notify_id;
    }
