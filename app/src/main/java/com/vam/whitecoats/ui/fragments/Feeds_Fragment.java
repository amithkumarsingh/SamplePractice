...
public class Feeds_Fragment extends Fragment implements OnCustomClickListener, UiUpdateListener,OnFeedItemClickListener,ProfileUpdatedListener {

    public static final String TAG = Feeds_Fragment.class.getSimpleName();
    ...
    static Feeds_Fragment instance;
    ...
    public static Feeds_Fragment getInstance(){
        return instance;
    }

    public static Feeds_Fragment newInstance(Bundle customArgs) {
        Log.i(TAG, "Feeds_Fragment newInstance");
        Feeds_Fragment fragment = new Feeds_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.feeds_fragment, null);
    ...
    public void buildUserInterface(boolean fromOnCreate) {
        ...
        if (listOfFeeds.size() == 0 && !fromOnCreate) {
            ...
            if (feedProviderType != null && feedProviderType.equalsIgnoreCase(RestUtils.TAG_COMMUNITY)) {
                ...
                if (isAdmin) {
                    postAnUpdateLayout.setVisibility(View.VISIBLE);
                } else {
    ...
    private void setupAdapter() {
        ...
        allFeedsAdapter = new AllFeedsAdapter(getActivity(), Feeds_Fragment.this, doctorID, listOfFeeds, mRecyclerView, feedProviderType, channelName, channelID, realmManager.getDocSalutation(realm)+" "+docName,new OnSocialInteractionListener() {
            @Override
