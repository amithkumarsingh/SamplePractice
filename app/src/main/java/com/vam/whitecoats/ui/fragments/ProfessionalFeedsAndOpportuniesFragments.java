...
public class ProfessionalFeedsAndOpportuniesFragments extends Fragment implements UiUpdateListener, OnFeedItemClickListener {
    ...
    public static ProfessionalFeedsAndOpportuniesFragments newInstance(String navigatedFrom) {

        Bundle args = new Bundle();

        ProfessionalFeedsAndOpportuniesFragments fragment = new ProfessionalFeedsAndOpportuniesFragments();
