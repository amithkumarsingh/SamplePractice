...
public class CommunitySpotlightFeedsFragment extends Fragment implements UiUpdateListener, OnFeedItemClickListener {
    ...
    public static CommunitySpotlightFeedsFragment newInstance(String navigatedFrom) {

        Bundle args = new Bundle();

        CommunitySpotlightFeedsFragment fragment = new CommunitySpotlightFeedsFragment();
