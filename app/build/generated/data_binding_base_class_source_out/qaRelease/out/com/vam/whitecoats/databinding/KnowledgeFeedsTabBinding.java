...
public final class KnowledgeFeedsTabBinding implements ViewBinding {
  @NonNull
  ...
  private KnowledgeFeedsTabBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static KnowledgeFeedsTabBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static KnowledgeFeedsTabBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.knowledge_feeds_tab, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static KnowledgeFeedsTabBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new KnowledgeFeedsTabBinding((LinearLayout) rootView, aviInTimeline, makepost,
