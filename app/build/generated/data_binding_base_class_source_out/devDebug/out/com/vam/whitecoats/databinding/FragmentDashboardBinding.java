...
public final class FragmentDashboardBinding implements ViewBinding {
  ...
  private FragmentDashboardBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull LinearLayout meSectionVerify, @NonNull View separator, @NonNull View separator1,
      @NonNull TextView textView11, @NonNull TextView textView7, @NonNull TextView textView9,
  ...
  public static FragmentDashboardBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDashboardBinding((LinearLayout) rootView, binding_addPublicationsLayout1,
          dashLayoutContatcs, dashLayoutCoserooms, dashLayoutGroup, dashTextContGroups,
          dashTextContNum, dashTextCoseroomsNum, meSectionVerify, separator, separator1, textView11,
          textView7, textView9, verifyNowText);
    }
