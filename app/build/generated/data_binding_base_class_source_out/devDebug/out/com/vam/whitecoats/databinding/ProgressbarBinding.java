...
public final class ProgressbarBinding implements ViewBinding {
  ...
  private ProgressbarBinding(@NonNull LinearLayout rootView,
      @NonNull AVLoadingIndicatorView avIndicator, @NonNull ProgressBar progressBar1) {
    this.rootView = rootView;
    this.avIndicator = avIndicator;
  ...
  public static ProgressbarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.avIndicator;
      AVLoadingIndicatorView avIndicator = ViewBindings.findChildViewById(rootView, id);
      if (avIndicator == null) {
        break missingId;
      }
      ...
      return new ProgressbarBinding((LinearLayout) rootView, avIndicator, progressBar1);
    }
