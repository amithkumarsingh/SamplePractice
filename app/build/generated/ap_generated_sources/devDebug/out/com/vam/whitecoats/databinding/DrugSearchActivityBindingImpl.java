...
public class DrugSearchActivityBindingImpl extends DrugSearchActivityBinding  {
    ...
    public DrugSearchActivityBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private DrugSearchActivityBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.adapter == variableId) {
            setAdapter((com.vam.whitecoats.ui.adapters.DrugSearchRecyclerAdapter) variable);
        }
        else if (BR.viewModel == variableId) {
            setViewModel((com.vam.whitecoats.viewmodel.DrugSearchViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setAdapter(@Nullable com.vam.whitecoats.ui.adapters.DrugSearchRecyclerAdapter Adapter) {
    ...
    public void setViewModel(@Nullable com.vam.whitecoats.viewmodel.DrugSearchViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        com.vam.whitecoats.ui.adapters.DrugSearchRecyclerAdapter adapter = mAdapter;
        java.lang.Boolean viewModelIsListVisibleGet = null;
        com.vam.whitecoats.viewmodel.DrugSearchViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x28L) != 0) {
            ...
            this.rvDrugsList.setAdapter(adapter);
        }
        if ((dirtyFlags & 0x32L) != 0) {
            // api target 1

            com.vam.whitecoats.databinding.RecyclerViewDataBinding.listVisibility(this.rvDrugsList, androidxDatabindingViewDataBindingSafeUnboxViewModelIsListVisibleGet);
        }
    }
