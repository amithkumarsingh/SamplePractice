...
public class ActivityDrugSubClassBindingImpl extends ActivityDrugSubClassBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.doceree_ad_layout, 6);
    }
    // views
    @NonNull
    ...
    public ActivityDrugSubClassBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 7, sIncludes, sViewsWithIds));
    }
    private ActivityDrugSubClassBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.drugSubClassAviInExplore.setTag(null);
        this.drugSubClassRecycler.setTag(null);
        this.drugSubClassRefresh.setTag(null);
        this.mboundView3 = (android.widget.TextView) bindings[3];
        this.mboundView3.setTag(null);
        this.rlContentLayout.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.adapter == variableId) {
            setAdapter((com.vam.whitecoats.ui.adapters.DrugSubClassAdapter) variable);
        }
    ...
    public void setAdapter(@Nullable com.vam.whitecoats.ui.adapters.DrugSubClassAdapter Adapter) {
    ...
    protected void executeBindings() {
        ...
        com.vam.whitecoats.ui.adapters.DrugSubClassAdapter adapter = mAdapter;
        ...
        if ((dirtyFlags & 0x31L) != 0) {
            ...
            com.vam.whitecoats.databinding.RecyclerViewDataBinding.listVisibility(this.drugSubClassAviInExplore, androidxDatabindingViewDataBindingSafeUnboxViewModelIsLoaderVisibleGet);
        }
        if ((dirtyFlags & 0x28L) != 0) {
            // api target 1

            this.drugSubClassRecycler.setAdapter(adapter);
        }
        if ((dirtyFlags & 0x32L) != 0) {
            // api target 1

            com.vam.whitecoats.databinding.RecyclerViewDataBinding.listVisibility(this.drugSubClassRecycler, androidxDatabindingViewDataBindingSafeUnboxViewModelIsListVisibleGet);
        }
        if ((dirtyFlags & 0x34L) != 0) {
            // api target 1
