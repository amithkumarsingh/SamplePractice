...
public class FragmentCategoriesRecentTabBindingImpl extends FragmentCategoriesRecentTabBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.feed_search_layout, 5);
    }
    // views
    @NonNull
    ...
    public FragmentCategoriesRecentTabBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private FragmentCategoriesRecentTabBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.adapter == variableId) {
            ...
            setViewModel((com.vam.whitecoats.viewmodel.RecentCategoriesViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.vam.whitecoats.viewmodel.RecentCategoriesViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        com.vam.whitecoats.viewmodel.RecentCategoriesViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x28L) != 0) {
            ...
            this.feedList.setAdapter(adapter);
        }
        if ((dirtyFlags & 0x32L) != 0) {
            // api target 1

            com.vam.whitecoats.databinding.RecyclerViewDataBinding.listVisibility(this.feedList, androidxDatabindingViewDataBindingSafeUnboxViewModelIsListVisibleGet);
        }
        if ((dirtyFlags & 0x34L) != 0) {
            // api target 1
