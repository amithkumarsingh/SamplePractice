...
public class FragmentCategoriesSpecialityTabBindingImpl extends FragmentCategoriesSpecialityTabBinding  {
    ...
    public FragmentCategoriesSpecialityTabBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private FragmentCategoriesSpecialityTabBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.specialityList.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.adapter == variableId) {
            setAdapter((com.vam.whitecoats.ui.adapters.SpecialityTabAdapter) variable);
        }
        else if (BR.viewModel == variableId) {
            setViewModel((com.vam.whitecoats.viewmodel.SpecialityTabViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setAdapter(@Nullable com.vam.whitecoats.ui.adapters.SpecialityTabAdapter Adapter) {
    ...
    public void setViewModel(@Nullable com.vam.whitecoats.viewmodel.SpecialityTabViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        com.vam.whitecoats.ui.adapters.SpecialityTabAdapter adapter = mAdapter;
        java.lang.Boolean viewModelIsListVisibleGet = null;
        com.vam.whitecoats.viewmodel.SpecialityTabViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x28L) != 0) {
            ...
            this.specialityList.setAdapter(adapter);
        }
        if ((dirtyFlags & 0x32L) != 0) {
            // api target 1

            com.vam.whitecoats.databinding.RecyclerViewDataBinding.listVisibility(this.specialityList, androidxDatabindingViewDataBindingSafeUnboxViewModelIsListVisibleGet);
        }
    }
