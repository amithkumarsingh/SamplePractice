...
public class ActivityDrugsBindingImpl extends ActivityDrugsBinding  {
    ...
    public ActivityDrugsBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private ActivityDrugsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.drugAviInExplore.setTag(null);
        this.drugRecycler.setTag(null);
        this.drugsRefersh.setTag(null);
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.adapter == variableId) {
            setAdapter((com.vam.whitecoats.ui.adapters.DrugAdapter) variable);
        }
        else if (BR.viewModel == variableId) {
            setViewModel((com.vam.whitecoats.viewmodel.DrugsViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setAdapter(@Nullable com.vam.whitecoats.ui.adapters.DrugAdapter Adapter) {
    ...
    public void setViewModel(@Nullable com.vam.whitecoats.viewmodel.DrugsViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        com.vam.whitecoats.ui.adapters.DrugAdapter adapter = mAdapter;
        java.lang.Boolean viewModelIsListVisibleGet = null;
        com.vam.whitecoats.viewmodel.DrugsViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x31L) != 0) {
            ...
            com.vam.whitecoats.databinding.RecyclerViewDataBinding.listVisibility(this.drugAviInExplore, androidxDatabindingViewDataBindingSafeUnboxViewModelIsLoaderVisibleGet);
        }
        if ((dirtyFlags & 0x28L) != 0) {
            // api target 1
