...
public class FragmentExploreBindingImpl extends FragmentExploreBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.adapter == variableId) {
            setAdapter((com.vam.whitecoats.ui.adapters.ExploreAdapter) variable);
        }
        else if (BR.viewModel == variableId) {
            setViewModel((com.vam.whitecoats.viewmodel.ExploreViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setAdapter(@Nullable com.vam.whitecoats.ui.adapters.ExploreAdapter Adapter) {
    ...
    public void setViewModel(@Nullable com.vam.whitecoats.viewmodel.ExploreViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        com.vam.whitecoats.ui.adapters.ExploreAdapter adapter = mAdapter;
        java.lang.Boolean viewModelIsListVisibleGet = null;
        com.vam.whitecoats.viewmodel.ExploreViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x28L) != 0) {
            ...
            this.categotyGrid.setAdapter(adapter);
        }
        if ((dirtyFlags & 0x32L) != 0) {
            // api target 1

            com.vam.whitecoats.databinding.RecyclerViewDataBinding.listVisibility(this.categotyGrid, androidxDatabindingViewDataBindingSafeUnboxViewModelIsListVisibleGet);
        }
        if ((dirtyFlags & 0x34L) != 0) {
            // api target 1
