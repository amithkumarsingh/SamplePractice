...
public class ActivitySubCategoriesListBindingImpl extends ActivitySubCategoriesListBinding  {
    ...
    public ActivitySubCategoriesListBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private ActivitySubCategoriesListBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.subCategoriesList.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.adapter == variableId) {
            setAdapter((com.vam.whitecoats.ui.adapters.SubCategoriesAdapter) variable);
        }
        else if (BR.viewModel == variableId) {
            setViewModel((com.vam.whitecoats.viewmodel.SubCategoriesViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setAdapter(@Nullable com.vam.whitecoats.ui.adapters.SubCategoriesAdapter Adapter) {
    ...
    public void setViewModel(@Nullable com.vam.whitecoats.viewmodel.SubCategoriesViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        com.vam.whitecoats.ui.adapters.SubCategoriesAdapter adapter = mAdapter;
        java.lang.Boolean viewModelIsListVisibleGet = null;
        com.vam.whitecoats.viewmodel.SubCategoriesViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x28L) != 0) {
            ...
            this.subCategoriesList.setAdapter(adapter);
        }
        if ((dirtyFlags & 0x32L) != 0) {
            // api target 1

            com.vam.whitecoats.databinding.RecyclerViewDataBinding.listVisibility(this.subCategoriesList, androidxDatabindingViewDataBindingSafeUnboxViewModelIsListVisibleGet);
        }
    }
