...
final class LoadAndDisplayImageTask implements Runnable, IoUtils.CopyListener {
	...
	public LoadAndDisplayImageTask(ImageLoaderEngine engine, ImageLoadingInfo imageLoadingInfo, Handler handler) {
		...
		filepath=imageLoadingInfo.filepath;
	...
	private Bitmap tryLoadBitmap() throws TaskCancelledException {
		Bitmap bitmap = null;
		try {
			File imageFile = configuration.diskCache.get(filepath);
	...
	private Bitmap decodeImage(String imageUri) throws IOException {
		...
		ImageDecodingInfo decodingInfo = new ImageDecodingInfo(memoryCacheKey, imageUri, uri,filepath, targetSize, viewScaleType,
	...
	private boolean resizeAndSaveImage(int maxWidth, int maxHeight) throws IOException {
		...
		if (targetFile != null && targetFile.exists()) {
			...
			ImageDecodingInfo decodingInfo = new ImageDecodingInfo(memoryCacheKey,
					Scheme.FILE.wrap(targetFile.getAbsolutePath()), uri,filepath, targetImageSize, ViewScaleType.FIT_INSIDE,
