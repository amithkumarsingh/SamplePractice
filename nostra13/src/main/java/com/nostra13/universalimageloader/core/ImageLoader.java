...
public class ImageLoader {
	 ...
	 * @throws IllegalArgumentException if passed <b>imageAware</b> is null
	 */
	public void displayImage(String uri,String filepath ,ImageAware imageAware, DisplayImageOptions options,
			ImageLoadingListener listener) {
		displayImage(uri, filepath,imageAware, options, listener, null);
	}
	...
	public void displayImage(String uri,String filepath, ImageAware imageAware, DisplayImageOptions options,
		...
		if (bmp != null && !bmp.isRecycled()) {
			...
			if (options.shouldPostProcess()) {
				ImageLoadingInfo imageLoadingInfo = new ImageLoadingInfo(uri, filepath,imageAware, targetSize, memoryCacheKey,
	 ...
	 * @throws IllegalArgumentException if passed <b>imageView</b> is null
	 */
	public void displayImage(String uri, String filepath,ImageView imageView, ImageLoadingListener listener) {
		displayImage(uri, filepath,new ImageViewAware(imageView), null, listener, null);
	}
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public void loadImage(String uri,String filepath, ImageLoadingListener listener) {
		loadImage(uri,filepath, null, null, listener, null);
	}
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public void loadImage(String uri,String filepath, ImageSize targetImageSize, ImageLoadingListener listener) {
		loadImage(uri,filepath, targetImageSize, null, listener, null);
	}
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public void loadImage(String uri,String filepath, DisplayImageOptions options, ImageLoadingListener listener) {
		loadImage(uri,filepath, null, options, listener, null);
	}
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public void loadImage(String uri,String filepath, ImageSize targetImageSize, DisplayImageOptions options,
			ImageLoadingListener listener) {
		loadImage(uri,filepath, targetImageSize, options, listener, null);
	}
	...
	public void loadImage(String uri,String filepath,ImageSize targetImageSize, DisplayImageOptions options,
		...
		displayImage(uri,filepath,imageAware, options, listener, progressListener);
	}
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public Bitmap loadImageSync(String uri,String filepath) {
		return loadImageSync(uri,filepath ,null, null);
	}
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public Bitmap loadImageSync(String uri,String filepath, DisplayImageOptions options) {
		return loadImageSync(uri, filepath,null, options);
	}
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public Bitmap loadImageSync(String uri,String filepath, ImageSize targetImageSize) {
		return loadImageSync(uri,filepath, targetImageSize, null);
	}
	 ...
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public Bitmap loadImageSync(String uri,String filepath, ImageSize targetImageSize, DisplayImageOptions options) {
		if (options == null) {
			options = configuration.defaultDisplayImageOptions;
		}
		...
		loadImage(uri,filepath, targetImageSize, options, listener);
